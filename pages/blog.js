        ...
        <div className="flex flex-col lg:flex-row justify-center gap-8">
          <div className="w-full lg:w-5/12 flex flex-col justify-center">
            ...
            <p className="catamaran font-normal text-base lg:mr-20 text-center lg:text-left text-gray-600  ">
              ...
              radical responsibility are non-optional conditions for working at
              Bench. Uncover how your job can help us change lives, show us how
              it’s done, and take charge of your career.
            </p>
          </div>
        ...
        <div className="flex  lg:flex-row flex-col-reverse justify-center md:py-12 md:px-6 gap-14 py-10  ">
          ...
          <div className="w-full lg:w-5/12 flex flex-col justify-center">
            ...
            <p className="catamaran text-base lg:mr-20 text-center lg:text-left text-gray-600  ">
              {" "}
              We’re here to change the outcome of small businesses
              everywhere—for the better. That means you won’t just collect a pay
              cheque while working here. You’ll do something that’s never been
              done before (and improve lives in the process).
            </p>
          </div>
        </div>
      </div>
